...
Below is a listing of all the parts required to build a D-Pad as well as the parts needed for

optional quality of life features.  There is one part that falls in-between and a decision
