...
This folder contains the code that you will upload to the RP2040 for it to function as a volume control device.
...
1\. Download the latest stable 1.0x CircuitPython UF2 from the official website \[here](https://circuitpython.org/board/pimoroni\_tiny2040/).
